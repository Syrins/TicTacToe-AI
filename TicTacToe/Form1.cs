...
namespace TicTacToe
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        //0 = Kolay, 1 = Orta, 2 = Zor, 3 = Arkadasinla Oyna
        int iType = 1;
        ...
        //Dur -1 = X Kazan, 0 = Ciz, 1 = O Kazan, 2 = Devam Et
        int CheckGameStatus()
        {
            // -
        ...
        void RunBot()
        {
            //3 = Arkadaşınla oyna , 0 = Kaybettin
            if (iType == 3 || iTurn == 0)
                return;
        ...
        void RunMediumBot()
        {
            ...
            {
                CheckWinAndDontLose(iOpponent); //Kontrol et Kaybetme
                CheckWinAndDontLose(iTurn); //Kazanani kontrol et
            ...
            else if (iData[iLastMove] != 0)
            {
                ...
                if (iData[iLastMove] != 0)
                {
                    ...
                    else if (iLastMove == 1 || iLastMove == 3 || iLastMove == 5 || iLastMove == 7)
                    {
                        ...
                        //Kenarlar rakip olduğunda köşeye yapıştır
